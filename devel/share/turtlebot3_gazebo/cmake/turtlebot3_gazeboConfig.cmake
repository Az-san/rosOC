...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot3_gazebo_SOURCE_PREFIX /home/user/rosOC/src/tb3_pkgs/turtlebot3_simulations/turtlebot3_gazebo)
  set(turtlebot3_gazebo_DEVEL_PREFIX /home/user/rosOC/devel)
  ...
  set(turtlebot3_gazebo_INSTALL_PREFIX /home/user/rosOC/install)
...
if(NOT "/home/user/rosOC/src/tb3_pkgs/turtlebot3_simulations/turtlebot3_gazebo/include " STREQUAL " ")
  set(turtlebot3_gazebo_INCLUDE_DIRS "")
  set(_include_dirs "/home/user/rosOC/src/tb3_pkgs/turtlebot3_simulations/turtlebot3_gazebo/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot3_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/rosOC/src/tb3_pkgs/turtlebot3_simulations/turtlebot3_gazebo/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/user/rosOC/devel/lib;/opt/ros/noetic/lib)
