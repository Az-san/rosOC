...
if("TRUE" STREQUAL "TRUE")
  set(openslam_gmapping_SOURCE_PREFIX /home/user/rosOC/src/openslam_gmapping)
  set(openslam_gmapping_DEVEL_PREFIX /home/user/rosOC/devel)
  ...
  set(openslam_gmapping_INSTALL_PREFIX /home/user/rosOC/install)
...
if(NOT "/home/user/rosOC/src/openslam_gmapping/include;/home/user/rosOC/devel/include " STREQUAL " ")
  set(openslam_gmapping_INCLUDE_DIRS "")
  set(_include_dirs "/home/user/rosOC/src/openslam_gmapping/include;/home/user/rosOC/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'openslam_gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/rosOC/src/openslam_gmapping/${idir}'.  ${_report}")
    endif()
