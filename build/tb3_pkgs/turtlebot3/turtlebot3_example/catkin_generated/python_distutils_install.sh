...
echo_and_run cd "/home/user/rosOC/src/tb3_pkgs/turtlebot3/turtlebot3_example"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/user/rosOC/src/tb3_pkgs/turtlebot3/turtlebot3_example/setup.py" \
     \
    build --build-base "/home/user/rosOC/build/tb3_pkgs/turtlebot3/turtlebot3_example" \
    install \
    --root="${DESTDIR-/}" \
